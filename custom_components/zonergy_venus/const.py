...
# These names identify the read-only ESP32 firmware that talks to the original
# Zonergy Wi-Fi dongle over Bluetooth Low Energy.
BLE_REQUIRED_ENTITY_NAMES: Final = {
    "Zonergy BLE Potenza Fotovoltaico",
    "Zonergy BLE Potenza Carico",
    "Zonergy BLE Stato di Carica Batteria",
}
BLE_ENTITY_PREFIX: Final = "Zonergy BLE "
